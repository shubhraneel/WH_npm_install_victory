...
`;
function StudentSearchCard(props) {
  return (
    <Container>
      <img
        src={
          props.profilePic ? props.profilePic : 'https://picsum.photos/600/600'
        }
        alt="Profile"
      />
...
export default memo(StudentSearchCard);
